...
# Title: Gr Antenna
# Generated: Thu Mar  8 12:02:05 2018
##################################################
...
class gr_antenna(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_head_0, 0), (self.antchar_dbm_correction_py_ff_0, 0))
        self.connect((self.blocks_head_0_0_0, 0), (self.antchar_Antenna_switch_c_0, 0))
