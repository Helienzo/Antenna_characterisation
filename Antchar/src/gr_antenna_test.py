...
class gr_antenna_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Gr Antenna Test")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Gr Antenna Test")
        ...
        self.blocks_stream_to_vector_0_0_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, fft_size/dec)
        self.blocks_stream_to_vector_0_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, fft_size)
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, fft_size)
        self.blocks_null_sink_1 = blocks.null_sink(gr.sizeof_float*fft_size/dec)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_float*1)
        self.blocks_nlog10_ff_0_0 = blocks.nlog10_ff(10, fft_size/dec, 0)
        ...
        self.blocks_complex_to_mag_squared_0_0 = blocks.complex_to_mag_squared(fft_size/dec)
        ...
        self.connect((self.blocks_stream_to_vector_0_0_0, 0), (self.blocks_complex_to_mag_squared_0_0, 0))
...
def main(top_block_cls=gr_antenna_test, options=None):
