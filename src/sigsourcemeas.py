...
class sigsourcemeas(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sigsourcemeas")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sigsourcemeas")
        try:
        ...
        self.qtgui_freq_sink_x_1 = qtgui.freq_sink_c(
        	...
        	c_freq, #fc
        	samp_rate/dec_1/dec_2/dec_3, #bw
        	"", #name
        	1 #number of inputs
        )
        ...
        self.freq_xlating_fir_filter_xxx_2 = filter.freq_xlating_fir_filter_ccc(dec_2, (1e4, ), 0, samp_rate/dec_1)
        self.freq_xlating_fir_filter_xxx_1 = filter.freq_xlating_fir_filter_ccc(dec_1, (1e4, ), 0, samp_rate)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(10, (1e4, ), 0, samp_rate/dec_1/dec_2)
        ...
        self.connect((self.freq_xlating_fir_filter_xxx_1, 0), (self.freq_xlating_fir_filter_xxx_2, 0))    
        self.connect((self.freq_xlating_fir_filter_xxx_2, 0), (self.freq_xlating_fir_filter_xxx_0, 0))    
        self.connect((self.rtlsdr_source_0, 0), (self.blocks_null_sink_0, 0))    
        self.connect((self.rtlsdr_source_0, 0), (self.freq_xlating_fir_filter_xxx_1, 0))    
